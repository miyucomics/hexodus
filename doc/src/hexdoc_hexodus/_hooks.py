...
import hexdoc_hexodus

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexodusPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexodusModPlugin(branch=branch)


class HexodusModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexodus"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexodus, "_templates"
